...
\begin{innerlist}
    \item Worked with \href{https://cs.uwaterloo.ca/~m2nagapp/}{Prof. Mei Nagappan} on the empirical modeling of sentiments in GitHub Pull Request discussions
\end{innerlist}
...
\textbf{Frameworks}
\begin{innerlist}
    \item[] Amazon Web Services, Google Cloud Platform, Firebase, Android Dev, Docker,  Scikit-Learn, Matplotlib, NLTK, Keras, NetworkX, Flask, Scikit-Image, Chart.js 
\end{innerlist}
