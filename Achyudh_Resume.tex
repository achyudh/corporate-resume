...
\textbf{Teaching Assistant, University of Waterloo} \hfill \emph{Sep '17 -- Present} 
\begin{innerlist}
...
\href{http://achyudh.xyz/publications/reviewability.pdf}{\textbf{What Makes a Code Change Easier to Review? An Empirical Investigation on Code Change Reviewability} \hfill \emph{2018}}
\begin{innerlist}
    \item[] \emph{26th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering}
\end{innerlist}

\halfblankline

\href{http://achyudh.xyz/publications/pyid.pdf}{\textbf{Investigating Type Declaration Mismatches in Python} \hfill \emph{2018}}
\begin{innerlist}
    \item[] \emph{IEEE Workshop on Machine Learning Techniques for Software Quality Evaluation}
\end{innerlist}
